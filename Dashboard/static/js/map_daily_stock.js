...
// Set the zoom level and default layer of map object with center. 
let map = L.map('mapid', {
    center: [40.7, -94.5],
    zoom: 3,
    layers: [streets]
...
// Create daily, monthly and region layer groups
...
d3.json(CompanyRegions).then(function(data) {
    ...
    L.geoJson(data, { style: style }).addTo(allRegions)
        // Then we add the regional layer to our map.  
